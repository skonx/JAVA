...
public class ComboBoxSample extends Application {
	...
	@Override public void start(Stage stage) {
		...
		emailComboBox.setOnAction((ActionEvent ev) -> {
			address = 
					emailComboBox.getSelectionModel().getSelectedItem();   
		});
		...
		priorityComboBox.setCellFactory(l-> new ColoredCell());
		priorityComboBox.setButtonCell(new ColoredCell());
		...
		button.setOnAction((ActionEvent e) -> {
			if (emailComboBox.getValue() != null && 
				...
				if (priorityComboBox.getValue() != null &&
						!priorityComboBox.getValue().isEmpty()){
