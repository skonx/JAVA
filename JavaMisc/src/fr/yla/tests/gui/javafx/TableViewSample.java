	...
	public void start(Stage stage) {
		...
		firstNameCol.setOnEditCommit(
				(CellEditEvent<Person, String> t) -> {
					((Person) t.getTableView().getItems().get(
							...
							).setFirstName(t.getNewValue().isEmpty()?t.getOldValue():t.getNewValue());
				});
		...
		lastNameCol.setOnEditCommit(
				(CellEditEvent<Person, String> t) -> {
					((Person) t.getTableView().getItems().get(
							t.getTablePosition().getRow())
							).setLastName(t.getNewValue().isEmpty()?t.getOldValue():t.getNewValue());
				});
		...
		emailCol.setOnEditCommit(
				(CellEditEvent<Person, String> t) -> {
					((Person) t.getTableView().getItems().get(
							t.getTablePosition().getRow())
							).setEmail(t.getNewValue().isEmpty()?t.getOldValue():t.getNewValue());
				});
		...
		/* Add two columns in the email column
